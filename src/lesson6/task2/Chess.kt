...
data class Square(val column: Int, val row: Int) {
     ...
     */
    fun notation(): String = if (inside()) (96 + column).toChar() + row.toString() else ""
}
 ...
 */
fun color(square: Square): Boolean { //true - black, false - white
    return if (square.column % 2 != 0) square.row % 2 != 0
    else square.row % 2 == 0
}
